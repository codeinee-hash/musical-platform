...
export function Player() {
    const { pause, setPause, volume, setVolume, currentTime, setCurrentTime, duration, setDuration, active }
        = usePlayer();
        ...
        <div className="h-[80px] w-full fixed bottom-0 bg-slate-100">
            <div className='h-full max-w-[1200px] mx-auto px-[24px] flex gap-30 items-center justify-between'>
                ...
                <div className='flex-1'>
                    <TrackProgress left={currentTime} right={duration} onChange={changeCurrentTime} isTime />
                </div>
